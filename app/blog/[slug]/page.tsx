...
const PostPage = (props: any) => {
  ...
  return (
    <section>
      <h1 className="font-bold text-3xl font-serif mb-5">{post.data.title}</h1>
      <h2 className="mb-5">{post.data.subtitle}</h2>

      <div className="grid grid-cols-[auto_1fr_auto] items-center mt-4 mb-8 font-mono text-sm max-w-2xl">
