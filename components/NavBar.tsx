...
const Navbar = () => {
  ...
  return (
    <aside className="md:w-40 md:flex-shrink-0 -mx-4 md:mx-0 md:px-0 font-serif select-none">
            ...
            {Object.entries(navItems).map(([path, { name }]) => {
              ...
              return (
                <Link
                  ...
                  href={path}
                  className={clsx(
                    'transition-all hover:text-neutral-800 dark:hover:text-neutral-200 py-1 px-2',
                    {
